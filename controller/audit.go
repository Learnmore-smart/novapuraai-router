...
var auditContentTemplates = map[string]string{
	...
	"user.topup_complete":          "Completed top-up ${trade_no} for user ${target_user_id} (${quota_added} quota)",
	...
	"email.provider_switch":        "Switched transactional email provider to ${provider}",
