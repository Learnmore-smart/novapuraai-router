...
var defaultModelRatio = map[string]float64{
	...
	// grok
	// grok-4.5 official list price: $2 / 1M input, $6 / 1M output (completion ratio 3)
	"grok-4.5":              1,
	"grok-4":                1.5,
	"grok-3-beta":           1.5,
...
func getHardcodedCompletionModelRatio(name string) (float64, bool) {
	...
	// SpaceXAI / xAI list prices use higher output rates on flagship Grok models.
	if strings.HasPrefix(name, "grok-4.5") || strings.HasPrefix(name, "grok-4") {
		return 3, false
	}
	switch name {
