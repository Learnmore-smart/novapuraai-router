...
func TestIsAlwaysSkipRetryCode_ClientDisconnectAndTimeout(t *testing.T) {
	require.True(t, IsAlwaysSkipRetryCode(types.ErrorCodeClientDisconnected))
	require.True(t, IsAlwaysSkipRetryCode(types.ErrorCodeUpstreamTimeout))
	require.True(t, IsAlwaysSkipRetryCode(types.ErrorCodeBadResponseBody))
	require.False(t, IsAlwaysSkipRetryCode(types.ErrorCodeDoRequestFailed))
}
