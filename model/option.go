...
func InitOptionMap() {
	...
	// Secrets are environment-managed (Secret Manager). Never seed OptionMap
	// with their values; expose configured flags for the admin UI only.
	common.OptionMap["GitHubClientSecret"] = ""
	common.OptionMap["GitHubClientSecretConfigured"] = strconv.FormatBool(strings.TrimSpace(common.GitHubClientSecret) != "")
	...
	common.OptionMap["TurnstileSecretKeyConfigured"] = strconv.FormatBool(strings.TrimSpace(common.TurnstileSecretKey) != "")
	common.OptionMap["TurnstileAllowedHostnames"] = common.TurnstileAllowedHostnames
	common.OptionMap["SMTPTokenConfigured"] = strconv.FormatBool(common.SMTPToken != "")
