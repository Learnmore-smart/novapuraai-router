...
// filterAbilitiesByRequestPathAndModel removes channels in a live cooldown from
// the DB selection path. It also path-checks Advanced Custom (type 58) channels
// when a request path is supplied.
