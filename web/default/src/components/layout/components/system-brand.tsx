...
export function SystemBrand(props: SystemBrandProps) {
  ...
  const name = status?.system_name || props.defaultName || 'NovaPuraAI'
  const version =
  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'group text-foreground inline-flex h-9 min-w-0 items-center gap-2.5 rounded-md px-1.5 text-[0.9375rem] font-semibold tracking-tight transition-colors outline-none select-none',
