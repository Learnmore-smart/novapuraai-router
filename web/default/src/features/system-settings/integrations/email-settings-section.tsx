      ...
      <Form {...form}>
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)} autoComplete='off'>
          ...
          <FormItem>
            ...
            <FormDescription>
              {t(
                'Set SMTP_TOKEN via environment (AWS SES SMTP password from Google Secret Manager on Cloud Run). It is never stored in the database or returned by the settings API.'
              )}
            </FormDescription>
          </FormItem>
        </SettingsForm>
