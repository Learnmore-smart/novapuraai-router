    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          StripeTestTopupProductID: settings.StripeTestTopupProductID,
          StripeProdTopupProductID: settings.StripeProdTopupProductID,
          StripeTestAccountID: settings.StripeTestAccountID,
          StripeProdAccountID: settings.StripeProdAccountID,
          StripeTopupEnabled: settings.StripeTopupEnabled,
        ...
        stripeCredentialStatus={{
          runtimeEnvironment: settings.StripeRuntimeEnvironment,
          test: {
            secretConfigured: settings.StripeTestSecretConfigured,
            publishableConfigured: settings.StripeTestPublishableConfigured,
            webhookConfigured: settings.StripeTestWebhookConfigured,
          },
          production: {
            secretConfigured: settings.StripeProdSecretConfigured,
            publishableConfigured: settings.StripeProdPublishableConfigured,
            webhookConfigured: settings.StripeProdWebhookConfigured,
          },
        }}
        waffoDefaultValues={{
