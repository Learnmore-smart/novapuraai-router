...
const normalizeFormValues = (
  ...
  GitHubClientSecretConfigured: secretConfigured,
...
export function OAuthSection(props: OAuthSectionProps) {
  ...
  const onSubmit = async (values: OAuthFormValues) => {
    ...
    const changedKeys = (
      ...
      (key) =>
        key !== 'GitHubClientSecretConfigured' &&
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t(
                          'Stored securely and never returned by the settings API. If GITHUB_OAUTH_CLIENT_SECRET is set in the environment, it overrides this value.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
