...
export function SummaryCards() {
  ...
  const {
    ...
    cash: cashQuota,
    promo: promoQuota,
  } = getBalanceBreakdown(user?.quota, user?.cash_quota, user?.promo_quota)
          ...
          <div className='flex flex-col gap-2 sm:gap-3'>
            ...
            <div className='grid grid-cols-2 gap-2'>
              <div className='bg-card rounded-md border border-border px-2.5 py-2.5'>
                ...
                <div className='text-foreground mt-2 truncate text-xs font-semibold tabular-nums'>
              ...
              <div className='bg-card rounded-md border border-border px-2.5 py-2.5'>
                ...
                <div className='text-primary mt-2 truncate text-xs font-semibold tabular-nums'>
                  {formatQuota(promoQuota)}
                </div>
              </div>
            </div>
