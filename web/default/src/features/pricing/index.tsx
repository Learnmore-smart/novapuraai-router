  ...
  if (isLoading) {
    return (
      <PublicLayout showMainContainer={false}>
        <div className='mx-auto w-full max-w-[1800px] px-3 pt-[calc(var(--app-header-height)+1rem)] pb-8 sm:px-6 sm:pb-10 xl:px-8'>
    ...
    <PublicLayout showMainContainer={false}>
      <div className='relative border-b border-border'>
        <PageTransition className='relative mx-auto w-full max-w-[1800px] px-3 pt-[calc(var(--app-header-height)+1rem)] pb-8 sm:px-6 sm:pb-10 xl:px-8'>
          <div className='border-border mb-8 overflow-hidden rounded-xl border sm:mb-10 [&>section]:border-y-0'>
          ...
          <header className='mb-6 max-w-3xl border-b border-border pt-6 pb-8 sm:mb-10'>
            ...
            <p className='text-muted-foreground mt-2 max-w-2xl text-sm leading-relaxed'>
              {t(
                'Compare prepaid model rates, capabilities, and routing options before you generate a key and send traffic.'
              )}
            </p>
            <SearchBar
              value={searchInput}
