...
export type UsersDialogType = 'create' | 'update' | 'delete' | 'share-review'

export type ShareReviewStatus = 'pending' | 'approved' | 'rejected'

export interface ShareReviewSubmission {
  id: number
  user_id: number
  url: string
  platform: string
...
export interface ShareReviewQueueResponse {
  success: boolean
  message?: string
  data?: {
    items: ShareReviewSubmission[]
    total: number
    page: number
    page_size: number
  }
