  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        // Semi UI 2.x and date-fns-tz 1.x use the date-fns 2.x subpath API.
        // Keep the classic bundle on Semi's nested copy instead of the
        // date-fns 4.x version used by the default frontend workspace.
